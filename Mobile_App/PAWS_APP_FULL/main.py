...
class ConnectBLEScreen(Screen): ## Screen for connecting to BLE devices
    ...
    def on_devices_found(self, devices):
        ...
        if self.available_devices == None: # checks for an empty list
...
class DataScreen(Screen):
    ...
    def Update_Weather_Data_Callback(self,data):
...
class ControlScreen(Screen):
    ...
    def Weather_Updater_Toggle(self):
        if self.Weather_Update_Toggle_State == False  and self.Window_Override== False and self.Light_Override == False:
    ...
    def Toggle_Window_Override(self):
        self.debug.log("Toggled Window Overide")
        if self.Window_Override == True:
